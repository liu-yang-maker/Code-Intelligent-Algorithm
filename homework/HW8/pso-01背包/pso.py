...
class package:
    ...
    def __init__(self):
        ...
        self.D = 10
        # 物品价值
        self.Value = [55,10, 47, 5, 4, 50, 8, 61, 85, 87]#np.random.random(self.D) * 20
        # 物品重量
        self.Weight = [95,4,60,32,23,72,80,62,65,46]#np.random.random(self.D) * (self.Max_weight/self.D) * 3
